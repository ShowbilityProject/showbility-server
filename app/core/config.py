...
#     FRONTEND_HOST: str = "http://localhost:5173" 수정 필요
    ...
    def SQLALCHEMY_DATABASE_URI(self) -> PostgresDsn:
        return MultiHostUrl.build(
            scheme="sqlite+TURSO",
            username=self.TURSO_USER,
            password=self.TURSO_PASSWORD,
            host=self.TURSO_SERVER,
            port=self.TURSO_PORT,
            path=self.TURSO_DB,
        )
    ...
    def _enforce_non_default_secrets(self) -> Self:
        ...
        self._check_default_secret("TURSO_PASSWORD", self.TURSO_PASSWORD)
